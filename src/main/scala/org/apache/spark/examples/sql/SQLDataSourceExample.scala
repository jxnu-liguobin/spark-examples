...
object SQLDataSourceExample {
  ...
  private def runGenericFileSourceOptionsExample(spark: SparkSession): Unit = {
    ...
    val testCorruptDF0 = spark.read
      ...
      .parquet("examples/src/main/resources/dir1/", "examples/src/main/resources/dir1/dir2/")
    testCorruptDF0.show()
    // +-------------+
    // |         file|
    // +-------------+
    ...
    // dir1/file3.json is corrupt from parquet's view
    val testCorruptDF1 =
      spark.read.parquet("examples/src/main/resources/dir1/", "examples/src/main/resources/dir1/dir2/")
    testCorruptDF1.show()
    // +-------------+
    // |         file|
    // +-------------+
  ...
  private def runJsonDatasetExample(spark: SparkSession): Unit = {
    ...
    val otherPeopleDataset =
      spark.createDataset("""{"name":"Yin","address":{"city":"Columbus","state":"Ohio"}}""" :: Nil)
